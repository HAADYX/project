    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-h-square"></i> @lang('site.'.$module_name_plural)</li>
            </ol>
        </section>
                ...
                <div class="box-header with-border">
                    ...
                    <form action="{{route('dashboard.'.$module_name_plural.'.index')}}" method="get">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <button class="btn btn-ad-primary" type="submit"><i class="fa fa-search"></i>
                                    @lang('site.search')</button>
                                <a href="{{route('dashboard.'.$module_name_plural.'.create')}}" class="btn btn-ad-primary"><i
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (auth()->user()->hasPermission('update-'.$module_name_plural))
                                            ...
                                            {{-- <a href="{{ route('dashboard.hotelLogin',$row->id) }}" style="margin-top: -5px" class="btn btn-outline-success btn-sm">@lang('site.hotelLogin')</a> --}}
                                        @else
