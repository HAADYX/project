    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li> <a href="{{ route('dashboard.' . $module_name_plural . '.index') }}"><i class="fa fa-h-square"></i>
                        @lang('site.hotels')</a></li>
                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('dashboard.' . $module_name_plural . '.store') }}" method="post"
                        ...
                        <div class="form-group col-sm-12 ">
                            <button type="submit" class="btn btn-ad-primary"><i class="fa fa-plus"></i>
